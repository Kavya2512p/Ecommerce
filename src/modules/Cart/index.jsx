...
const Cart = () => {
    ...
    return (
        <div className='container mx-auto mt-10 px-4 sm:px-6 lg:px-8'>
            <div className='flex flex-wrap shadow-lg shadow-gray-600 my-10 lg:m-10'>
                <div className='w-full sm:w-3/4 bg-white px-4 py-5 sm:px-10 sm:py-10'>
                    ...
                    </div>
                    {
                        carts.map((cart, index) => (
                            <div key={index} className='flex flex-wrap items-center hover:bg-gray-100 -mx-4 px-4 py-5'>
                                ...
                                <span className='w-full sm:w-1/5 text-center font-semibold text-sm'>${cart.price}</span>
                                <span className='w-full sm:w-1/5 text-center font-semibold text-sm'>${(cart.price * cart.quantity).toFixed(2)}</span>
                            </div>
                        ))
                    }
                    <Link to='/products' className='flex font-semibold text-indigo-600 text-sm mt-10'>
                        <svg className='fill-current text-indigo-600 w-4 mr-2' viewBox='0 0 448 512'>
                        </svg>
                        Continue Shopping
                    </Link>
                </div>

                <div id='summary' className='w-full sm:w-1/4 px-4 py-5 sm:px-8 sm:py-10'>
